          ...
          <form id="form1" action="index.php" method="post">
            ...
            <div class="col-lg-6">
              <div class="input-group">
                <input type="text" class="form-control" id="cpfCliente" name="CPF" placeholder="Pesquisar CPF ou CNPJ" autocomplete="off">
            ...
            <form id="form2" action="../../App/Database/insertVendas.php" method="POST">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="exampleInputEmail1">Nome Cliente ou Razão Social</label>
                  <input type="text" name="nomeCliente" class="form-control" id="exampleInputnome1" placeholder="Nome Cliente ou Razão Social" value="<?php if(isset($_SESSION['Cliente'])){ echo $_SESSION['Cliente']; } ?>"/>
                </div>
              
                <div class="form-group">
                  <label for="exampleInputEmail1">CPF ou CNPJ</label>
                  <input type="number" name="cpfcliente" class="form-control" id="exampleInputcpf1" placeholder="CPF ou CNPJ" value="<?php if(isset($_SESSION['CPF'])){ echo $_SESSION['CPF']; } ?>" />
                </div>
